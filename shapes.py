...
if choice == '2':
    ...
    length = float(input('What is the length of the square, rectangle, and cube sides as well as the circle\'s radius? (one(1) number) '))
    square_area = length ** 2
    rect_area = length * length
    ...
    print(f'The area of the cube is: {cube_volume} units^2')
    print(f'The area of the circle is: {circle_area} units^2')

elif choice == '3':
    #calculate area of a square == length * length
    square_length = float(input('What is the length of a side of the square in centimetres? '))
    ...
    rect_length = float(input('What is the length of rectangle in centimetres? '))
    rect_width = float(input('What is the width of the rectangle in centimetres? '))
    ...
    circle_radius = float(input('What is the radius of the circle in centimetres? '))
